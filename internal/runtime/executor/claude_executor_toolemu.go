...
func (e *ClaudeExecutor) buildClaudeToolEmuSend(auth *cliproxyauth.Auth, url, apiKey string, extraBetas []string, signCCH bool, entrypoint string, helperProfile bool, incomingHeaders http.Header, confirmedClaudeCode bool, claudeSessionID string) toolemu.UpstreamSendFunc {
